...
import com.innova.ecommercestore.utils.EventObserver;
import com.innova.ecommercestore.utils.OnEventChanged;
import com.innova.ecommercestore.utils.OnNavigateToProductDetails;
import com.innova.ecommercestore.utils.ScheduleWork;
import com.innova.ecommercestore.models.Response;
import com.innova.ecommercestore.notification.NotificationWorker;
import com.innova.ecommercestore.ui.mainactivity.MainActivity;
import com.innova.ecommercestore.SignInUtil;
import com.innova.ecommercestore.models.Product;
import com.innova.ecommercestore.ui.productentryactivity.ProductEntryActivity;
import com.innova.ecommercestore.ui.mainactivity.fragments.productsfragment.recycleradapter.StaggeredProductCardRecyclerViewAdapter;
import com.innova.ecommercestore.utils.CustomStaggeredGridLayoutManager;
    ...
    View.OnClickListener textOnclickListner=new View.OnClickListener() {
        ...
        public void onClick(View v) {
            switch (v.getTag().toString()){
                ...
                case "Trending":{
                    productsAdapter.setProductList(productsFragmentViewModel.getTrendingProducts());
                    productsAdapter.notifyDataSetChanged();
                    v.setHovered(true);
                    selectedCategory.setHovered(false);
                    v.setHovered(true);
                ...
                case "Kids":{
                    productsAdapter.setProductList(productsFragmentViewModel.getkidsProducts());
                    productsAdapter.notifyDataSetChanged();
                    v.setHovered(true);
                    selectedCategory.setHovered(false);
                    selectedCategory= (TextView) v;
                ...
                case "Electronics":{
                    productsAdapter.setProductList(productsFragmentViewModel.getElectronics());
                    productsAdapter.notifyDataSetChanged();
                    v.setHovered(true);
                    selectedCategory.setHovered(false);
                    selectedCategory= (TextView) v;
...
*/
    ...
    public void onResume() {
        ...
        productsFragmentViewModel.getTrendingProducts();
