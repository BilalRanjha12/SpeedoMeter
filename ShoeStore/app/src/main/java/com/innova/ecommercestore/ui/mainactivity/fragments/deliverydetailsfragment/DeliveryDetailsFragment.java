...
import com.innova.ecommercestore.ui.mainactivity.fragments.checkoutfragment.CheckOutFragment;
    ...
    private void setUpBtnContinue() {
        ...
        btnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavHostFragment.findNavController(DeliveryDetailsFragment.this).navigate(R.id.action_deliveryDetailsFragment_to_availablecards);
